            ...
            <div style="font-family: 'Courier New', Courier, monospace; background: #fcf7f1; margin:0; padding:0;">
              ...
              <div style="max-width:600px;margin:32px auto 0 auto;background:#fff;padding:32px 24px 24px 24px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.04);">
                ...
                <p style="font-size:1.05rem;">
                  We&rsquo;re excited to have you as part of our Protos Adventure family. You&rsquo;ll now be the first to know about our best trending deals, exclusive offers, and new arrivals delivered straight to your inbox from time to time.
                </p>
                <p style="font-size:1.05rem;">
                ...
                <p style="font-size:1.05rem;margin-top:28px;margin-bottom:0;">
                  Happy Shopping!<br>
                  <strong>Team Protos Adventure</strong>
                </p>
                <div style="margin:28px 0 18px 0;">
                  <img src="https://www.protosadventures.com/_next/image?url=%2Flogo.png&w=256&q=75" alt="Protos Adventure Logo" style="height:64px;margin-bottom:8px;" />
                  <div style="font-size:1.1rem;font-weight:bold;margin-bottom:2px;">
                    Web: <a href="https://www.protosadventures.com" style="color:#0056b3;text-decoration:underline;">www.protosadventures.com</a>
                  </div>
              ...
              <div style="background:#ededed;padding:20px 0 16px 0;margin-top:32px;font-size:0.93rem;color:#222;border-top:2px solid #222;">
                <div style="max-width:700px;margin:0 auto;padding:0 16px;">
                  ...
                  <br><br>
                  If you would prefer not receiving our emails, please click here to <a href="https://www.protosadventures.com/unsubscribe" style="color:#0056b3;">unsubscribe</a>.<br>
                  <span style="color:#888;">© 2025 Protos Adventure. All rights reserved</span>
                </div>
              </div>
            </div>
          `
