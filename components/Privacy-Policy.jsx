      ...
      <div className="border border-black p-4 rounded-xl shadow-sm">
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-5">
            ...
            <div>
              <p className="text-justify" style={{ textAlign: 'justify' }}><b>9. Introduction to www.protosadventures.com (Website)  :- </b>
                ...
                on the Website from time to time. www.protosadventures.com (Website) at its sole discretion reserves the
                right not to accept a User from registering on the Website without assigning any reason thereof. provides
                a number of Internet-based services through the Web Site (all such services, collectively, the "service").
